...
export const CareerSection: React.FC = () => {
  return (
    <section id="career" className="py-24 bg-[#080d1a] border-t border-slate-800/80 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center sm:text-left mb-16 space-y-4">
          <div className="inline-block">
            <span className="inline-block bg-[#FACC15] text-black font-black uppercase tracking-widest text-sm sm:text-base px-3.5 py-1 rounded-sm shadow-md font-mono transform -rotate-1 hover:rotate-0 transition-transform">
              CAREERS
            </span>
          </div>
              ...
              >
                ...
                <div className="hidden sm:flex sm:col-span-1 justify-center relative h-full">
                  ...
                  {index !== CAREER_HISTORY.length - 1 && (
                    <div className="absolute top-6 bottom-[-4rem] w-[2px] bg-slate-800 group-hover:bg-slate-700 transition-colors" />
                  )}
                  {/* Hollow node circle */}
                  <div className="relative z-10 w-4 h-4 rounded-full border-2 border-slate-400 group-hover:border-cyan-400 bg-[#080d1a] mt-1 transition-all group-hover:scale-125 shadow-sm" />
                </div>

                {/* Right: Content Card / Details */}
                <div className="sm:col-span-8 pl-4 sm:pl-0 border-l-2 sm:border-l-0 border-slate-800 space-y-2">
        ...
        <div className="mt-16 pt-8 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-900/40 p-6 rounded-2xl border border-slate-800">
          <div className="flex items-center gap-3 text-center sm:text-left">
            ...
            <div>
              <h4 className="text-sm font-bold text-white">Full Professional Background on LinkedIn</h4>
              <p className="text-xs text-slate-400">View complete endorsements, recommendations, and speaking history.</p>
            </div>
          </div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs transition-all shadow-md shadow-blue-600/20 active:scale-95 shrink-0"
          >
